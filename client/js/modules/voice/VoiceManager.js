...
export class VoiceManager {
  ...
  showMicMenu(event, micIndex) {
    ...
    if (isSelf) {
      ...
      const perms = (currentUser && currentUser.permissions && typeof currentUser.permissions === 'object') ? currentUser.permissions : {};
      const canManageMics = isRoomOwner || isGlobalAdmin || perms.canTakeMic === true || perms.canRemoveMic === true;
