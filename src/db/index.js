...
const defaultSettings = {
  siteweb: { allowg: true, allowreg: true, name: "TigerHost Chat", title: "TigerHost Chat", background: "#40404f", bg: "#40404f", buttons: "#f93634", msgst: "5", walllikes: { lengthUserReg: 50, lengthUserG: 50 }, likeGates: { wall: 100, private: 200, story: 300, call: 400, mic: 500 } },
  dro3: [], emo: [], sico: [],
};
